...
parser.add_argument('--dataset_dir', type=str, default="/media/admini/My_data/submap_database/00", help='dataset_dir')
...
def train():
    ...
    with tqdm(train_loader) as tq:
        for item in tq:
            ...
            item_idx += 1
            if item_idx % 10000 == 0:
                torch.save(model.state_dict(), os.path.join(args.dataset_dir, "descriptor-dgcnn-kitti00.pth"))
