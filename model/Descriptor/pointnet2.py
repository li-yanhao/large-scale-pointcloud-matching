...
class PointNet2SSGCls(nn.Module):
    def __init__(self, output_classes, batch_size, input_dims=3, dropout_prob=0.4):
        ...
        self.sa_module1 = SAModule(4, batch_size, 0.2, [input_dims, 64, 64, 128], n_neighbor=4)
        self.sa_module2 = SAModule(4, batch_size, 0.4, [128 + 3, 128, 128, 256], n_neighbor=4)
...
if __name__ == '__main__':
    batch_size = 1
    net = PointNet2SSGCls(16, batch_size, input_dims=3)
    points = torch.Tensor(np.random.randn(1,18,3))
    net(points)
