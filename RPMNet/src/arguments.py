...
def rpmnet_arguments():
    ...
    parser.add_argument('--train_batch_size', default=1, type=int, metavar='N',
                        help='training mini-batch size (default 1)')
    parser.add_argument('-b', '--val_batch_size', default=1, type=int, metavar='N',
                        help='mini-batch size during validation or testing (default: 1)')
